@extends('layouts.admin', ['page' => 'Edit Slider'])
@section('content')
    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST"
                action="{{ route('admin.sliders.update', $slider) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                @if ($errors->any())
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview"
                            ...
                            <img src="{{ $slider->image ? asset('storage/' . $slider->image) : '' }}" class="effect8"
